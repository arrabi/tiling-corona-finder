...
class Corona {
    ...
    validate(allowedSizes = [1, 2, 3, 4]) {
        ...
        for (let ei = 0; ei < this.edges.length; ei++) {
            ...
            const segs = [...edge].sort((a, b) => a.offset !== b.offset ? a.offset - b.offset : a.size - b.size);
    ...
    toCompact() {
        ...
        for (const edge of this.edges) {
            const edgeSorted = [...edge].sort((a, b) => a.offset !== b.offset ? a.offset - b.offset : a.size - b.size);
...
function canonicalRotationEdges(edges) {
    function edgeKey(e) {
        const sorted = [...e].sort((a, b) => a.offset !== b.offset ? a.offset - b.offset : a.size - b.size);
